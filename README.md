...
> AI-powered video production platform for content creators.
...
`Flutter` `FastAPI` `Python` `Firebase` `Gemini AI` `Stability AI` `Cloudflare` `Render`
...
> Find nearby chargers, track your vehicle, manage your EV journey — all in one place.

`Flutter` `Firebase` `FastAPI` `Google Maps API`
...
```
Mobile & Web   →   Flutter · Dart · HTML · CSS
Backend        →   FastAPI · Python · Firebase
Infrastructure →   Cloudflare · Render · Firebase Hosting
AI             →   Gemini API · Stability AI
...
- **Guitar** — Trinity College London Grade 5 certified
- **Music Production** — Ableton Live
- **Badminton** — Tournament competitor
- **Location** — Pune, India
